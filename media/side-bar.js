...
const startTestGeneration = document.getElementById("start-test-generation-button");
const saveButton = document.getElementById("save-button-id"); 
const sauceUsernameTextField = document.getElementById("sauce-username-text-field-id"); 
const sauceAccessKeyTextField = document.getElementById("sauce-access-key-text-field-id"); 
const dataCenterTextField = document.getElementById("data_center-text-field-id"); 
