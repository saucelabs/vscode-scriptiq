...
export function generateAllRDCCheckboxes(container) {
  ...
  addRDCDeviceCheckboxes(container, 'Google', [
    ...
    'Google Pixel 4 XL Emulator',
    'Google Pixel 4a Emulator',
  ]);
  ...
  addRDCDeviceCheckboxes(container, 'Samsung', [
    ...
    'Samsung Galaxy Z Flip4 Android 13',
    'Samsung Galaxy Xcover6 Pro Android 13',
    ...
    'Samsung Galaxy S22',
    'Samsung Galaxy S21 Ultra 5G Android 13',
    'Samsung Galaxy S21 Plus 5G Android 13',
    'Samsung Galaxy S21 5G',
    'Samsung Galaxy Z Fold4',
    'Samsung Galaxy Z Flip4',
    'Samsung Galaxy Xcover6 Pro',
    'Samsung Galaxy S22 5G',
    'Samsung Galaxy S21 Ultra 5G Android 12',
    'Samsung Galaxy S21 Plus 5G Android 12',
    'Samsung Galaxy S21 Plus 5G',
    'Samsung Galaxy S20 Plus Android 12',
...
export function addRDCDeviceCheckboxes(container, key, specific_devices) {
  ...
  generateSpecificDeviceCheckboxes2(
    checkboxContainer,
    overallInput,
    specificCheckboxClass,
    specific_devices,
  );
 ...
 */
function generateSpecificDeviceCheckboxes2(
  checkboxContainer,
  genCheckbox,
  genDeviceCheckboxClass,
  deviceNames,
) {
  ...
  for (let div_n = 0; div_n < numDeviceCols; div_n++) {
    ...
    for (
      let x = Math.floor(numPerCol * div_n);
      x < Math.floor(numPerCol * (div_n + 1));
      x++
    ) {
