...
export class AppiumJava extends CodeTemplate {
    ...
    genCodeLine(bestIdentifier, action, number="") {
        var findElement = this.findElementCode(bestIdentifier.id_type, bestIdentifier.id_value, bestIdentifier.id_num);
     ...
     */
    noOptionComment() {
        return `<span ${this.code_comment_class}> // SKIP STEP</span>` + this.preNewLine;
    }
